...
* It crashes every time something tries to write to stdout or stderr because those aren't in the preopens. Adding those to the preopens should be possible with changes to Viceroy. It may also be possible to monkeypatch in Python and redirect them to a logging endpoint, but our initial attempts were unsuccessful.
